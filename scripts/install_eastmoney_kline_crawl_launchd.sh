...
<dict>
  ...
  <array>
    ...
    <string>$ROOT/scripts/crawl_eastmoney_kline_batch.sh</string>
  </array>
  ...
  <dict>
    ...
    <key>DELAY</key>
    <string>2</string>
    <key>SOURCE_COOLDOWN_MINUTES</key>
    <string>15</string>
  </dict>

  <key>StandardOutPath</key>
  <string>$LOG_DIR/eastmoney-kline-crawl.launchd.out.log</string>

  <key>StandardErrorPath</key>
  <string>$LOG_DIR/eastmoney-kline-crawl.launchd.err.log</string>
</dict>
</plist>
PLIST
...
echo "Schedule: Monday-Friday 16:20 local time"
