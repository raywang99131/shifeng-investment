/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 7b0faac70d96b42008399a282cab1df6)
...
interface __BaseEnv_Env {
	...
	DEV_RESEARCH_READ_ONLY: string;
	GITHUB_DISPATCH_TOKEN: string;
	RESEARCH_PUBLISH_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPO" | "LEGACY_API_ORIGIN" | "DEV_RESEARCH_READ_ONLY" | "GITHUB_DISPATCH_TOKEN" | "RESEARCH_PUBLISH_TOKEN">> {}
}
