/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/ice-cds-collector/wrangler.test.jsonc cloudflare/ice-cds-collector/worker-configuration.d.ts` (hash: 4c1b3792fa9a67d112d6acc91e53480a)
// Runtime types generated with workerd@1.20260820.1 2026-08-25
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "test";
	CDS_COLLECTOR: DurableObjectNamespace<import("./src/index").CdsCollector>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CdsCollector";
	}
